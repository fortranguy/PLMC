...
use class_inter_diameter, only: Abstract_Inter_Diameter, Concrete_Inter_Diameter

implicit none

    class(Abstract_Diameter), allocatable :: diameter_1, diameter_2
    class(Abstract_Inter_Diameter), allocatable :: inter_diameter_12
    ...
    allocate(Concrete_Diameter :: diameter_1)
    ...
    allocate(Concrete_Diameter :: diameter_2)
    ...
    allocate(Concrete_Inter_Diameter :: inter_diameter_12)
