...
use class_chemical_potential, only: Abstract_Chemical_Potential, Concrete_Chemical_Potential

implicit none

    class(Abstract_Chemical_Potential), allocatable :: chemical_potential
    ...
    allocate(Concrete_Chemical_Potential :: chemical_potential)
