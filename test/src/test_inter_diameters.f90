...
implicit none
    ...
    class(Abstract_Number), allocatable :: number_1, number_2
    ...
    call test_data_found(data_field, found)
    call diameters_2%construct(number_2)
    ...
    do i_particle = 1, number_1%get()
        do j_particle = 1, number_2%get()
