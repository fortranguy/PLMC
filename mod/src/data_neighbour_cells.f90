...
implicit none
    ...
    integer, parameter :: num_near_cells_layer = num_near_cells_dim(1) * num_near_cells_dim(2)
    integer, parameter :: num_near_cells = num_near_cells_layer * num_near_cells_dim(3)
