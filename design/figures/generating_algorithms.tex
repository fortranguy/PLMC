    ...
    \begin{tikzpicture}[scale=\scale, every node/.style={scale=\scale}]
        ...
        \begin{scope}[shift={($(BoxParticlesSwap.south) - (0 cm, 1.5 cm)$)}]
            \begin{class}[text width=\largeTextWidth]{GeneratingAlgorithms}{0, 0}
                ...
                \UMLattribute{oneParticleTranslation: \type{BoxParticleMove}}
                \UMLattribute{oneParticleRotation: \type{BoxParticleMove}}
                \UMLattribute{twoParticlesSwitch: \type{BoxParticlesSwap}}
                \UMLattribute{oneParticleAdd: \type{BoxParticleExchange}}
                \UMLattribute{oneParticleRemove: \type{BoxParticleExchange}}
                \UMLattribute{twoParticlesTransmutation: \type{BoxParticlesSwap}}
            \end{class}
        \end{scope}
