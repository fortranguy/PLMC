    ...
    \begin{tikzpicture}[scale=\scale, every node/.style={scale=\scale}]
        ...
        \begin{scope}
            \begin{abstractclass}[text width=\largeTextWidth]{VisitableCells}{0, 0}
                \operation{\procedure{construct}{periodicBox: \type{PeriodicBox},
                    ...
                    pairPotential: \type{PairPotential}, listMold: \type{VisitableList}}}
                \operation{\procedure{destroy}{}}
                \operation{\procedure{reset}{}}
                \operation{\procedure{set}{neighbourCells: \type{NeighbourCells}}}
                ...
                \operation{\procedure{visitContacts}{overlap: \type{bool}, contacts: \type{real},
                    ...
                    visitCondition: \procedure{visitCondition}
                        {iInside: \type{int}, iOutside: \type{int}},
                    iExclude: \type{int}}}
                \operation{\procedure{visitMinDistance}{canOverlap: \type{bool},
                    overlap: \type{bool}, ratio: \type{real}, particle: \type{TemporaryParticle},
                    visitCondition: \procedure{visitCondition}
                        {iInside: \type{int}, iOutside: \type{int}},
                    iExclude: \type{int}}}
        ...
        \begin{scope}[shift={($(HardContact.north) + (9 cm, 0 cm)$)}]
            ...
            \umlnote[text width=\largeTextWidth] {\import{}: \\
                ...
                \namespace{Changes} :: MaximumBoxCompression};
        \end{scope}
        ...
        \begin{scope}[shift={($(VisitableCells.north -| Import) + (0 cm, 2 cm)$)}]
            \begin{class}[text width=\largeTextWidth]{ShortInteractions}{0, 0}
                \UMLattribute{maximumBoxCompression: \type{MaximumBoxCompression}}
                \UMLattribute{betaPressureExcess: \type{BetaPressureExcess}}
        ...
        \begin{scope}[shift={($(VisitableCellsMemento.south) - (0 cm, 1.5 cm)$)}]
