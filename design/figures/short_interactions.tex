...
\begin{document}
    ...
    \begin{tikzpicture}[scale=\scale, every node/.style={scale=\scale}]
        ...
        \begin{scope}[shift={($(VisitableCells.north) + (0 cm, 6.5 cm)$)}]
        ...
        \begin{scope}[shift={($(DiracDistributionPlus.south) - (0 cm, 1.5 cm)$)}]
            \begin{abstractclass}[text width=\largeTextWidth]{VisitableList}{0, 0}
                \operation{\procedure{construct}{$\mathAggregation$ periodicBox: \type{PeriodicBox},
                    $\mathAggregation$ positions: \type{ComponentCoordinates},
                    hardContact: \type{HardContact},
                    $\mathAggregation$ pairPotential: \type{PairPotential}}}
                \operation{\procedure{destroy}{}}
                ...
                \operation{\procedure{visit}{overlap: \type{bool}, energy: \type{real},
                    ...
                    visitCondition: \procedure{visitCondition}
                        {iInside: \type{int}, iOutside: \type{int}},
                    iExclude: \type{int}}}
                \operation{\procedure{visit}{overlap: \type{bool}, contacts: \type{real},
                    particle: \type{TemporaryParticle},
                    minDistance: \type{real},
                    visitCondition: \procedure{visitCondition}
                        {iInside: \type{int}, iOutside: \type{int}},
                    iExclude: \type{int}}}
                \operation{\procedure{visit}{overlap: \type{bool}, ratio: \type{real},
                    particle: \type{TemporaryParticle},
