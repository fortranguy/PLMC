    ...
    \begin{tikzpicture}
        ...
        \begin{scope}
            \begin{abstractclass}[text width=\mediumTextWidth]{PairPotential}{0, 0}
                ...
                \operation{\procedure{getMaxDistance}{}\type{double}}
                \operation[0]{\procedure{meet}{overlap\type{bool}, energy\type{double},
                    distance\type{double}}}
            \end{abstractclass}
        \end{scope}
        ...
        \begin{abstractclass}[text width=\smallTextWidth]{PotentialExpression}{0, 0}
                \operation{\procedure{get}{distance\type{double}}\type{double}}
            \end{abstractclass}
        \end{scope}
        ...
        \begin{scope}[shift={($(PairPotential.north) + (0 cm, 6.5 cm)$)}]
            \begin{abstractclass}[text width=\mediumTextWidth]{ShortPairsVisitor}{0, 0}
                ...
                \operation{\procedure{visitInter}{overlap\type{bool}, energy\type{double},
                    positions1\type{ComponentCoordinates},
                    positions2\type{ComponentCoordinates},
                    pairPotential\type{PairPotential}}}
                \operation{\procedure{visitIntra}{overlap\type{bool}, energy\type{double},
