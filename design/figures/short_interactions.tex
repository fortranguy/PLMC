...
\begin{document}
    ...
    \begin{tikzpicture}
        ...
        \begin{package}{Short interactions}
            ...
            \begin{scope}[shift={($(PairPotential.north) + (2 cm, 6 cm)$)}]
            ...
            \begin{scope}[shift={($(ShortPairsVisitor.north) + (-13 cm, 0 cm)$)}]
                \begin{abstractclass}[text width=\largeTextWidth]{VisitableCells}{0, 0}
                    ...
                    \operation{remove(particle\type{TemporaryParticle})}
                \end{abstractclass}
            \end{scope}

            \begin{scope}[shift={($(VisitableCells.south |- PairPotential.north)$)}]
        ...
        \begin{scope}[on background layer]
            \aggregation{VisitableCells}{\refName{pairPotential}}{1}{PairPotential}
            \composition{VisitableCells}{\refName{visitableList}}{1..n}{VisitableList}
            \composition{PairPotential}{\refName{potentialExpression}}{1}{PotentialExpression}
        \end{scope}
