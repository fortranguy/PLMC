...
\begin{document}
    ...
    \begin{tikzpicture}[scale=\scale, every node/.style={scale=\scale}]
        ...
        \begin{scope}[shift={($(DiracDistributionPlus.south) - (0 cm, 1 cm)$)}]
        ...
        \begin{scope}[shift={($(VisitableList.south) - (0 cm, 1 cm)$)}]
        ...
        \begin{scope}[shift={($(ShortInteractions.south) - (0 cm, 1 cm)$)}]
            \begin{abstractclass}[text width=\largeTextWidth]{NeighbourCells}{0, 0}
                \operation{\procedure{construct}{$\mathAggregation$ accessibleDomain:
                    \type{ParallelepipedDomain}, pairPotential: \type{PairPotential},
                    hardContact: \type{HardContact}, dipolarNeighbourhood:
                    \type{DipolarNeighbourhood}}}
                \operation{\procedure{destroy}{}}
        ...
        \begin{scope}[shift={($(NeighbourCells.south) - (0 cm, 1 cm)$)}]
