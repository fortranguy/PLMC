...
\begin{document}
    ...
    \begin{tikzpicture}[scale=\scale, every node/.style={scale=\scale}]
        ...
        \begin{scope}[shift={($(MetropolisAlgorithm.north) + (0 cm, 6 cm)$)}]
        ...
        \begin{scope}[shift={($(MetropolisAlgorithm.north -| Import)$)}]
        ...
        \begin{scope}[shift={($(OneParticleExchange |- MetropolisAlgorithm.north)$)}]
