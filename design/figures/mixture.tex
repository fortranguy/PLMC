...
\begin{document}
    ...
    \begin{tikzpicture}[scale=\scale, every node/.style={scale=\scale}]
        ...
        \begin{scope}[shift={($(TemporaryParticle.north) + (0 cm, 3.5 cm)$)}]
        ...
        \begin{scope}[shift={($(ComponentAverageNumber.north -| ComponentDipoleMoments)$)}]
        ...
        \begin{scope}[shift={($(ComponentNumber.south) - (0 cm, 1 cm)$)}]
