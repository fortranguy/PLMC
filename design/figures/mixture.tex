...
\begin{document}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}[shift={($(ComponentNumber.north) + (7.5 cm, 0 cm)$)}]
        ...
        \begin{scope}[shift={($(ComponentCoordinates.north -| MinimumDistance.north)$)}]
        ...
        \begin{scope}[shift={($(Component.north -| ComponentDipolarMoments.north) + (0 cm, 2 cm)$)}]
        ...
        \begin{scope}[shift={($(Component.north -| MinimumDistance)$)}]
