...
\begin{document}
    ...
    \begin{tikzpicture}[scale=\scale, every node/.style={scale=\scale}]
        ...
        \begin{scope}[shift={($(Temperature.south) - (0 cm, 1.5 cm)$)}]
            \begin{abstractclass}[text width=\mediumTextWidth]{BoxVolumeMemento}{0, 0}
        ...
        \begin{scope}[shift={($(BoxVolumeMemento.south) - (0 cm, 1.5 cm)$)}]
        ...
        \begin{scope}[shift={($(FloorPenetration.south |- PeriodicBox.north)$)}]
        ...
        \begin{scope}[shift={($(PeriodicBox |- BoxSizeChecker.north)$)}]
            \begin{abstractclass}[text width=\largeTextWidth]{ReciprocalLattice}{0, 0}
        ...
        \begin{scope}[shift={($(ReciprocalLattice.south) - (0 cm, 1.5 cm)$)}]
        ...
        \begin{scope}[on background layer]
            ...
            \aggregation{BoxVolumeMemento}{\refName{periodicBox}}{\numRef{1}}{PeriodicBox}
        \end{scope}
    \end{tikzpicture}
