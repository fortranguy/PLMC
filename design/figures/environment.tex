...
\begin{document}
    ...
    \begin{tikzpicture}[scale=\scale, every node/.style={scale=\scale}]
        ...
        \begin{scope}[shift={($(Temperature.north) + (0 cm, 3 cm)$)}]
        ...
        \begin{scope}[shift={($(Permittivity.north) + (0 cm, 3 cm)$)}]
        ...
        \begin{scope}[shift={($(VisitableWalls.south) - (0 cm, 1.5 cm)$)}]
            \begin{class}[text width=\mediumTextWidth]{Environment}{0, 0}
                ...
                \attribute{wallMinDistance: \type{MinDistance}}
                \attribute{wallsPotential: \type{VisitableWalls}}
                \attribute{boxSizeChecker: \type{BoxSizeChecker}}
                \attribute{accessibleDomain: \type{ParallelepipedDomain}}
            \end{class}
        \end{scope}
