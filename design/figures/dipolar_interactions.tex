...
\begin{document}
    ...
    \begin{tikzpicture}[scale=\scale, every node/.style={scale=\scale}]
        ...
        \begin{scope}[shift={($(DESconvergenceParameter.north) + (0 cm, 5.5 cm)$)}]
        ...
        \begin{scope}[shift={($(DESconvergenceParameter.south) - (0 cm, 2 cm)$)}]
        ...
        \begin{scope}[shift={($(StructureVisitor.north) + (13 cm, 0 cm)$)}]
