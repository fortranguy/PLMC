    ...
    \begin{tikzpicture}[scale=\scale, every node/.style={scale=\scale}]
        ...
        \begin{scope}
            \begin{abstractclass}[text width=\largeTextWidth]{DESrealComponent}{0, 0}
                \operation{\procedure{construct}{periodicBox: \type{PeriodicBox,
                    boxVolumeMemento: \type{BoxVolumeMemento},
        ...
        \begin{scope}[shift={($(DESselfComponent.north) + (9 cm, 0 cm)$)}]
            ...
            \umlnote[text width=\largeTextWidth]{\import{}:: \\
                \namespace{Environment} :: PeriodicBox, BoxVolumeMemento, ReciprocalLattice,
                    Permittivity \\
        ...
        \begin{scope}[shift={($(Import.south) - (0 cm, 4 cm)$)}]
            \begin{abstractclass}[text width=\largeTextWidth]{DipolarVisitor}{0, 0}
        ...
        \begin{scope}[shift={($(DESrealPair.north -| Import) - (0 cm, 1.5 cm)$)}]
            \begin{class}[text width=\largeTextWidth]{DipolarInteractions}{0, 0}
                \UMLattribute{boxVolumeMemento: \type{BoxVolumeMemento}}
        ...
        \begin{scope}[shift={($(DESconvergenceParameter.south)!0.5!(DipolarInteractions.south) -
            (0 cm, 3.5 cm)$)}]
