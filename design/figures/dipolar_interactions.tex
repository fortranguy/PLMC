...
\begin{document}
    ...
    \begin{tikzpicture}
        ...
        \begin{scope}[shift={($(DESconvergenceParameter.north) + (13 cm, 0 cm)$)}]
        ...
        \begin{scope}[shift={($(DESreciVisitor.north) + (13 cm, 0 cm  )$)}]
            \begin{abstractclass}[text width=\largeTextWidth]{DESreciStructure}{0, 0}
                ...
                \operation{\procedure{updateAdd}{iComponent\type{int},
                    particle\type{TemporaryParticle}}}
                \operation{\procedure{updateRemove}{iComponent\type{int},
                    particle\type{TemporaryParticle}}}
