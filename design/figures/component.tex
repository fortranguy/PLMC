...
\begin{document}
    ...
    \begin{tikzpicture}
        \begin{package}{Component}
            ...
            \begin{scope}[shift={($(ComponentNumber.north) + (9 cm, 0)$)}, opacity=1]
            ...
            \begin{scope}[shift={($(Coordinates.south) + (0 cm, -1.5 cm)$)}, opacity=1]
            ...
            \begin{scope}[shift={($(ComponentCoordinates.north) + (11 cm, 0 cm)$)}, opacity=1]
