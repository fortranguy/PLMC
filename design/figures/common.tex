    ...
    \begin{tikzpicture}[scale=\scale, every node/.style={scale=\scale}]
        ...
        \begin{scope}[shift={($(PLMCpropagator.north) - (9 cm, 0 cm)$)}]
            \begin{class}[text width=\largeTextWidth]{PhysicalModel}{0, 0}
                ...
                \UMLattribute{dipolarInteractionsDynamic: \type{DipolarInteractionsDynamic}}
                \UMLattribute{dipolarInteractionsStatic: \type{DipolarInteractionsStatic}}
                \UMLattribute{dipolarInteractionsFacades: \type{DipolarInteractionsFacade}}
            \end{class}
        \end{scope}
