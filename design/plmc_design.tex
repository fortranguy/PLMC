...
\begin{document}
    ...
    Notations:
    \begin{itemize}
        \item \type{Type[:, ..., :]} is an array of \type{Type}.
        ...
        \item $\mathAggregation$ \textsf{object}: \type{Class} and
            $\mathComposition$ \textsf{object}: \type{Class} are shorthands for aggregation and
            composition respectively. They are used when \type{Class} is defined outside the current
            namespace, cf. \textsf{\import{}}.
    \end{itemize}
