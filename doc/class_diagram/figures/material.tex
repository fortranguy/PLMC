\begin{scope}[local bounding box=Material, opacity=0.25]
    \begin{package}{Material}
        ...
        \begin{scope}[shift={($(AbstractNumber.north) + (7 cm, 0 cm)$)}, opacity=0.5]
        ...
        \begin{scope}[shift={($(AbstractDiameter.north) + (7 cm, 0 cm)$)}, opacity=0.5]
        ...
        \begin{scope}[shift={($(AbstractDiameter.north) + (-9 cm, 8 cm)$)}, opacity=0.5]
        ...
        \begin{scope}[shift={($(AbstractInterDiameters.north) + (0 cm, 6 cm)$)}, opacity=0.5]
...
\begin{scope}[on background layer]
    ...
    \aggregation{AbstractDipolarMoments}{momentNorm}{1}{AbstractMomentNorm}
    ...
    \aggregation{AbstractTotalMoment}{momentNorm}{1}{AbstractDipolarMoments}
\end{scope}
