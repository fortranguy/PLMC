\begin{scope}[local bounding box=Material, opacity=0.25]
    \begin{package}{Material}
        ...
        \begin{scope}[shift={($(AbstractParticlesNumber.north) + (0 cm, 10 cm)$)}, opacity=0.5]
            \begin{abstractclass}[text width=\mediumTextWidth]{AbstractDiameters}{0, 0}
                \operation{contruct(particlesNumber\type{AbstractParticlesNumber})}
                \operation{destroy()}
        ...
        \begin{scope}[shift={($(AbstractDiameters.north) + (9 cm, 0 cm)$)}, opacity=0.5]
        ...
        \begin{scope}[shift={($(AbstractMomentsNorm.north) + (9 cm, 0 cm)$)}, opacity=0.5]
        ...
        \begin{scope}[shift={($(AbstractPositions.north) + (9 cm, 0 cm)$)}, opacity=0.5]
        ...
        \begin{scope}[shift={($(DipolarMomentsFacade.north) + (9 cm, 5 cm)$)}]
            ...
            \begin{class}[text width=\mediumTextWidth]{TotalMoment}{0, -3.5}
        ...
        \begin{scope}[shift={($(AbstractMovedPositions.north)!0.5!(AbstractRotatedOrientations.north) +
            (0 cm, 4 cm)$)}]
...
\begin{scope}[on background layer]
    ...
    \aggregation{RandomCoordinatesFacade}{randPositions}{1}{AbstractMovedPositions}
    \aggregation{RandomCoordinatesFacade}{randMoments}{1}{AbstractRotatedOrientations}
    
    \aggregation{AbstractRotatedOrientations}{orientations}{1}{AbstractOrientations}
    
    \aggregation{AbstractTotalMoment}{momentsNorm}{1}{DipolarMomentsFacade}
\end{scope}
