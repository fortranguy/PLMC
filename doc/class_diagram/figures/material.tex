\begin{scope}[local bounding box=Material, opacity=0.25]
    \begin{package}{Material}
        ...
        \begin{scope}[shift={($(AbstractParticlesNumber.north) + (0 cm, 10 cm)$)}, opacity=1]
        ...
        \begin{scope}[shift={($(DipolarMomentsFacade.north) + (9 cm, 5 cm)$)}, opacity=1]
            ...
            \begin{class}[text width=\mediumTextWidth]{NullTotalMoment}{0, -4}
                \inherit{AbstractTotalMoment}
            \end{class}
        \end{scope}
        
        \begin{scope}[shift={($(AbstractMovedPositions.north)!0.5!
                             (AbstractRotatedOrientations.north) + (0 cm, 4 cm)$)}]
