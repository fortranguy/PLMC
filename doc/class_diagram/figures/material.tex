\begin{scope}[local bounding box=Material, opacity=0.5]
    \begin{package}{Material}
        ...
        \begin{scope}[shift={($(AbstractPeriodicBox.north) - (20 cm, 0)$)}]
            \begin{abstractclass}[text width=\mediumTextWidth]{AbstractDiametersReservoir}{0, 0}
        ...
        \begin{scope}[shift={($(AbstractDiameters.north) + (0 cm, 4 cm)$)}, opacity=1]
            \begin{abstractclass}[text width=\mediumTextWidth]{AbstractInterDiameters}{0, 0}
                \operation{construct(sphere1\type{AbstractDiameters},
                                     sphere2\type{AbstractDiameters},
        ...
        \begin{scope}[shift={($(AbstractInterDiameters.north) + (9 cm, 0 cm)$)}]
        ...
        \begin{scope}[shift={($(AbstractPeriodicBox.north) + (0 cm, 5 cm)$)}]
            \begin{abstractclass}[text width=\smallTextWidth]{AbstractBoxedDiameters}{0, 0}
...
\begin{scope}[on background layer]
    ...
    \aggregation{AbstractBoxedDiameters}{periodicBox}{1}{AbstractPeriodicBox}
    \aggregation{AbstractBoxedDiameters}{positions}{1}{AbstractPositions}
    \aggregation{AbstractInterDiameters}{sphere}{2}{AbstractDiameters}
