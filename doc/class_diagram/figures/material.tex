\begin{scope}[local bounding box=Material, opacity=0.5]
    \begin{package}{Material}
        ...
        \begin{scope}[shift={($(AbstractPeriodicBox.north) + (11 cm, 0 cm)$)}]
            \begin{abstractclass}[text width=\smallTextWidth]{AbstractReciprocalLattice}{0, 0}
                \operation[0]{setReciNum(reciNum\type{int[3]})}
                \operation[0]{getReciNum()\type{int[3]}}
            \end{abstractclass}
            
            \def\operationsImplementation{
                \operation{setReciNum(reciNum\type{int[3]})}
                \operation{getReciNum()\type{int[3]}}
            }
            
            \begin{class}[text width=\smallTextWidth]{NullReciprocalLattice}{0, -3}
                \inherit{AbstractReciprocalLattice}
                \operationsImplementation{}
            \end{class}
            
            \begin{class}[text width=\smallTextWidth]{ReciprocalLattice}{0, -5.5}
                \inherit{AbstractReciprocalLattice}
                \operationsImplementation{}
            \end{class}
        \end{scope}
        ...
        \begin{scope}[shift={($(AbstractSpheres.north) + (9 cm, 0 cm)$)}, opacity=1]
            \begin{abstractclass}[text width=\mediumTextWidth]{AbstractDipolarMomentNorms}{0, 0}
                \operation{contruct(particleNum\type{AbstractParticlesNumber})}
                \operation{destroy()}
...
\begin{scope}[on background layer]
    \aggregation{ReciprocalLattice}{box}{1}{AbstractPeriodicBox}
    \aggregation{AbstractSpheres}{number}{1}{AbstractParticlesNumber}
    \aggregation{AbstractDipolarMomentNorms}{number}{1}{AbstractParticlesNumber}
    ...
    \aggregation{TotalMoment}{dipMoment}{1}{AbstractDipolarMomentNorms}
