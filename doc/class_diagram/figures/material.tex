\begin{scope}[local bounding box=Material, opacity=0.5]
    \begin{package}{Material}
        ...
        \begin{scope}[shift={($(AbstractSphere.north) + (-7 cm, 0 cm)$)}, opacity=1]
        ...
        \begin{scope}[shift={($(AbstractSphere.north) + (0 cm, 4 cm)$)}, opacity=1]
            \begin{abstractclass}[text width=\mediumTextWidth]{AbstractInterSpheres}{0, 0}
                \operation{setDiameter(sphere1\type{AbstractSphere},
                                       sphere2\type{AbstractSphere},
