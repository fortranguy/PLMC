\begin{scope}[shift={($(Particles.north) + (42 cm, 55 cm)$)}]
    \begin{package}{Dipolar interactions}
        ...
        \begin{scope}[shift={($(DipolarInteraction.south) + (-19.5 cm, -5 cm)$)}]
            \begin{abstractclass}[text width=\largeTextWidth]{EwaldRealParticles}{0, 0}
                \operation{construct(periodicBox\type{PeriodicBox},
                    particlesPositions\type{ParticlesPositions},
                    particlesDipolarMoments\type{ParticlesDipolarMoments})}
                \operation{destroy()}
        ...
        \begin{scope}[shift={($(EwaldRealParticles.south) + (0 cm, -1.5 cm)$)}]
...
\begin{scope}[on background layer]
    \aggregation{DipolarInteractionFacade}{ewaldReal}{2}{EwaldRealParticles}
    ...
    %\aggregation{EwaldRealParticles}{dipSpheres}{1}{DipolarSpheres}
