\begin{scope}[shift={($(Component.north) + (42 cm, 55 cm)$)}]
    \begin{package}{Dipolar interactions}
        ...
        \begin{scope}[shift={($(DipolarInteraction.south) + (-19.5 cm, -5 cm)$)}]
            \begin{abstractclass}[text width=\largeTextWidth]{EwaldRealComponent}{0, 0}
                \operation{construct(periodicBox\type{PeriodicBox},
                    componentPositions\type{ComponentPositions},
                    componentDipolarMoments\type{ComponentDipolarMoments},
                    ewaldRealPair\type{EwaldRealPair})}
                \operation{destroy()}
                \operation{visit(energy\type{double}, particle\type{Particle},
                    ewaldRealPair\type{EwaldRealPair})}
                \operation{visit(field\type{double[3]}, particle\type{Particle},
                    ewaldRealPair\type{EwaldRealPair})}
            \end{abstractclass}
        \end{scope}

        \begin{scope}[shift={($(EwaldRealComponent.south) + (0 cm, -1.5 cm)$)}]
            \begin{abstractclass}[text width=\mediumTextWidth]{EwaldRealPair}{0, 0}
                \operation{construct(domain\type{PotentialDomain}, alpha\type{double})}
                \operation{destroy()}
                \operation{meet(vectorIJ\type{double[3]}, momentI\type{double[3]},
                    momentJ\type{double[3]})\type{double}}
            \end{abstractclass}
        \end{scope}
...
\begin{scope}[on background layer]
    \aggregation{DipolarInteractionFacade}{ewaldReal}{2}{EwaldRealComponent}
    ...
    %\aggregation{EwaldRealComponent}{dipSpheres}{1}{DipolarSpheres}
    ...
    \aggregation{EwaldBound}{totalMoment}{1}{ComponentTotalMoment}

    \aggregation{FieldInteraction}{totalMoment}{1}{ComponentTotalMoment}
