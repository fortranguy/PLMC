...
\begin{scope}[on background layer]
    ...
    \aggregation{AbstractDipolarInteraction}{box}{1}{AbstractPeriodicBox}

    \aggregation{EwaldReal}{dipSpheres}{1}{AbstractDipolarSpheres}

    \aggregation{EwaldReci}{dipSpheres}{1}{AbstractDipolarSpheres}

    \aggregation{DipolarLayerCorrection}{dipSpheres}{1}{AbstractDipolarSpheres}

    \aggregation{EwaldSelf}{dipSpheres}{1}{AbstractDipolarSpheres}
