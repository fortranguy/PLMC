...
\begin{package}{Particles}
    ...
    \begin{scope}[shift={($(ParticlesNumber.north) + (0 cm, 11 cm)$)}, opacity=1]
        \begin{abstractclass}[text width=\mediumTextWidth]{ParticlesCoordinates}{0, 0}
    ...
    \begin{scope}[shift={($(ParticlesCoordinates.south) + (-4.5 cm, -1.5 cm)$)}, opacity=1]
        \begin{abstractclass}[text width=\mediumTextWidth]{ParticlesPositions}{0, 0}
            \inherit{ParticlesCoordinates}
    ...
    \begin{scope}[shift={($(ParticlesCoordinates.north) + (9 cm, 0 cm)$)}, opacity=1]
