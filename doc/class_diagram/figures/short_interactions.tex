\begin{scope}[shift={($(Material.north) + (-28 cm, 55 cm)$)}, opacity=0.5]
    \begin{package}{Short range interactions}
        ...
        \begin{scope}[shift={($(PairPotentialFacade.south) + (-5 cm, -2 cm)$)}]
            \begin{abstractclass}[text width=\mediumTextWidth]{CellsPotential}{0, 0}
                \operation{construct(periodicBox\type{PeriodicBox},
            ...
            \begin{class}[text width=\mediumTextWidth]{XYZCellsPotential}{0, -6}
                \inherit{CellsPotential}
                \operationsImplementation{}
            \end{class}
            
            \begin{class}[text width=\mediumTextWidth]{XYCellsPotential}{0, -8}
                \inherit{CellsPotential}
                \operationsImplementation{}
            \end{class}
        \end{scope}

        \begin{scope}[shift={($(CellsPotential.north) + (-10 cm, -3cm)$)}, opacity=1]
...
\begin{scope}[on background layer]
    ...
    \aggregation{CellsPotential}{visitableList}{1..n}{VisitableList}
    \aggregation{VisitableList}{periodicBox}{1}{PeriodicBox}
    \aggregation{VisitableList}{pairPotential}{1}{PairPotential}
    \aggregation{VisitableList}{positions}{1}{Positions}
    
    \aggregation{PairPotential}{potentialExpression}{1}{PotentialExpression}

    \aggregation{CellsPotential}{periodicBox}{1}{PeriodicBox}
    \aggregation{CellsPotential}{positions}{1}{Positions}
