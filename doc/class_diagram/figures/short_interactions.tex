...
\begin{scope}[on background layer]
    \aggregation{AbstractPairInteraction}{box}{1}{AbstractPeriodicBox}
    ...
    \aggregation{AbstractNeighbourCells}{box}{1}{AbstractPeriodicBox}
    ...
    \aggregation{WallsInteraction}{box}{1}{AbstractPeriodicBox}
