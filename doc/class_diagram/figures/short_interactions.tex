\begin{scope}[shift={($(Material.north) + (-28 cm, 55 cm)$)}, opacity=0.5]
    \begin{package}{Short range interactions}
        ...
        \begin{scope}[shift={($(PairPotentialFacade.south) + (-7 cm, -2 cm)$)}, opacity=1]
...
\begin{scope}[on background layer]
    ...
    \aggregation{PairPotentialFacade}{cellsPotential}{1}{VisitableCells}
    ...
    \aggregation{BoxPotentialFacade}{positions}{1}{ParticlesPositions}
    ...
    \aggregation{WallsInteraction}{positions}{1}{ParticlesPositions}
\end{scope}
