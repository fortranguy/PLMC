...
\begin{scope}[on background layer]
    ...
    \aggregation{AbstractDipolarInteraction}{boxGeometry}{1}{AbstractBoxGeometry}

    \aggregation{EwaldReal}{dipolarSpheres}{1}{AbstractDipolarSpheres}

    \aggregation{EwaldReci}{dipolarSpheres}{1}{AbstractDipolarSpheres}

    \aggregation{DipolarLayerCorrection}{dipolarSpheres}{1}{AbstractDipolarSpheres}

    \aggregation{EwaldSelf}{dipolarSpheres}{1}{AbstractDipolarSpheres}
