\begin{scope}[local bounding box=Material]
    \begin{package}{Material}
        ...
        \begin{scope}[local bounding box=Spheres]
            ...
            \begin{class}[text width=\mediumTextWidth]{ApolarSpheres}{0, -6}
                \inherit{AbstractDipolarSpheres}
                \operationsImplementation{}
            \end{class}
            
            \begin{class}[text width=\mediumTextWidth]{DipolarSpheres}{0, -10}
                \inherit{AbstractDipolarSpheres}
                \operationsImplementation{}
            \end{class}
        \end{scope}
...
\begin{scope}[on background layer]
    ...
    \aggregation{AbstractRandomCoordinates}{randMoments}{1}{AbstractRandomMoments}
    ...
    \aggregation{RandomMoments}{dipSpheres}{1}{AbstractDipolarSpheres}
