\begin{scope}[local bounding box=Material]
    \begin{package}{Material}
        ...
        \begin{scope}[shift={($(Spheres.north) + (0 cm, 16 cm)$)}]
            ...
            \begin{class}[text width=\mediumTextWidth]{RandomPositions}{0, -4}
                \inherit{AbstractRandomCoordinates}
                \operationsImplementation{}
            \end{class}

            \begin{class}[text width=\mediumTextWidth]{RandomCoordinates}{0, -7}
                \inherit{AbstractRandomCoordinates}
                \operationsImplementation{}
            \end{class}
        \end{scope}
...
\begin{scope}[on background layer]
    ...
    \aggregation{AbstractRandomCoordinates}{box}{1}{AbstractBoxGeometry}
    \aggregation{AbstractRandomCoordinates}{spheres}{1}{AbstractDipolarSpheres}
