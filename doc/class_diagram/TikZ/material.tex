    ...
    \begin{package}{Material}
        ...
        \begin{scope}[local bounding box=Spheres]
            \begin{abstractclass}[text width=\mediumTextWidth]{AbstractDipolarSpheres}{0, 0}
                ...
                \operation[0]{add(position : double[3], moment : double[3])}
            \end{abstractclass}
            ...
            \def\operationsImplementation{
                ...
                \operation{add(position : double[3], moment : double[3])}
            }
        ...
        \begin{scope}[shift={($(Spheres.north) + (0 cm, 16 cm)$)}]
            \begin{abstractclass}[text width=\mediumTextWidth]{AbstractRandomCoordinates}{0, 0}
                \operation[0]{position(): double[3]}
                \operation[0]{moment(): double[3]}
                \operation[0]{move(iSphere : int) : double[3]}
        ...
        \begin{scope}[shift={($(RandomCoordinates.south) + (8 cm, -2 cm)$)}]
        ...
        \begin{scope}[shift={($(RandomCoordinates.south) + (16 cm, -2 cm)$)}]
            \begin{abstractclass}[text width=\mediumTextWidth]{AbstractRandomMoments}{0, 0}
                \operation[0]{moment(): double[3]}
                \operation[0]{rotation(iSphere : int) : double[3]}
            \end{abstractclass}
            ...
            \begin{class}[text width=\mediumTextWidth]{NullRandomMoments}{0, -3}
                \inherit{AbstractRandomMoments}
                \operationImplementation{}
            \end{class}
            
            \begin{class}[text width=\mediumTextWidth]{RandomMoments}{0, -5.5}
                \inherit{AbstractRandomMoments}
                \operationImplementation{}
            \end{class}
        \end{scope}
...
\begin{scope}[on background layer]
    \aggregation{AbstractBoxedSpheres}{boxGeometry}{1}{AbstractBoxGeometry}
    \aggregation{AbstractBoxedSpheres}{dipolarSpheres}{1}{AbstractDipolarSpheres}
    
    \aggregation{RandomCoordinates}{randPositions}{1}{AbstractRandomPositions}
    \aggregation{RandomCoordinates}{randMoments}{1}{AbstractRandomMoments}
    
    \aggregation{AbstractRandomPositions}{boxGeometry}{1}{AbstractBoxGeometry}
    \aggregation{AbstractRandomPositions}{dipolarSpheres}{1}{AbstractDipolarSpheres}
    
    \aggregation{RandomMoments}{dipolarSpheres}{1}{AbstractDipolarSpheres}
    
    \aggregation{TotalMoment}{dipolarSpheres}{1}{AbstractDipolarSpheres}
\end{scope}
