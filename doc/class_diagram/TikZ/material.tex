\begin{scope}[local bounding box=Material]
    \begin{package}{Material}
        ...
        \begin{scope}[shift={($(RandomCoordinates.south) + (16 cm, -2 cm)$)}]
            ...
            \begin{class}[text width=\mediumTextWidth]{ApolarRandomMoments}{0, -3}
                \inherit{AbstractRandomMoments}
                \operationImplementation{}
            \end{class}
            
            \begin{class}[text width=\mediumTextWidth]{DipolarRandomMoments}{0, -5.5}
                \inherit{AbstractRandomMoments}
                \operationImplementation{}
            \end{class}
        \end{scope}
...
\begin{scope}[on background layer]
    ...
    \aggregation{AbstractRandomPositions}{spheres}{1}{AbstractDipolarSpheres}
    
    \aggregation{AbstractRandomMoments}{spheres}{1}{AbstractDipolarSpheres}
