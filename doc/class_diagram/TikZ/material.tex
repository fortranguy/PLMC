\begin{scope}[local bounding box=Material]
    \begin{package}{Material}
        ...
        \begin{scope}[local bounding box=SphereBox]
            \begin{abstractclass}[text width=\smallTextWidth]{AbstractSphere}{0, 0}
                \operation{getDiameter() : double}
            \end{abstractclass}
        \end{scope}
        
        \begin{scope}[shift={($(SphereBox.north) - (7cm, 0cm)$)}]
            \begin{abstractclass}[text width=\smallTextWidth]{AbtractNumberOfParticles}{0, 0}
                \operation{setNum(num: integer)}
                \operation{getNum(): integer}
            \end{abstractclass}
        \end{scope}

        \begin{scope}[shift={($(SphereBox.north) + (7cm, 0cm)$)}]
            \begin{abstractclass}[text width=\smallTextWidth]{AbstractDipolarMoment}{0, 0}
                \operation{getNorm(): double}
            \end{abstractclass}
        \end{scope}
        
        \begin{scope}[shift={($(Spheres.north) + (0 cm, 5cm)$)},
            local bounding box=PositionsBox]
        ...
        \begin{scope}[shift={($(SphereBox.north) + (7 cm, 5cm)$)}]
        ...
        \begin{scope}[shift={($(Spheres.north) - (20 cm, 0)$)}, local bounding box=BoxGeometry]
        ...
        \begin{scope}[shift={($(PositionsBox.north) + (0, 8 cm)$)},
        ...
        \begin{scope}[shift={($(Orientations.north) + (0 cm, 8 cm)$)},
        ...
        \begin{scope}[shift={($(RandomPositionsBox.north)!0.5!(RandomOrientationsBox.north) + 
                               (0 cm, 4 cm)$)}, local bounding box=RandomCoordinatesBox]
        ...
        \begin{scope}[shift={($(RandomCoordinatesBox.north) + (14 cm, 0 cm)$)}]
