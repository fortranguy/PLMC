...
\begin{scope}[on background layer]
    ...
    \aggregation{OneSphereMove}{dipolarSpheres}{2}{AbstractDipolarSpheres}
    ...
    \aggregation{OneSphereRotation}{dipolarSpheres}{2}{AbstractDipolarSpheres}
    ...
    \aggregation{TwoSpheresSwitch}{dipolarSpheres}{2}{AbstractDipolarSpheres}
    ...
    \aggregation{OneSphereExchange}{dipolarSpheres}{2}{AbstractDipolarSpheres}
