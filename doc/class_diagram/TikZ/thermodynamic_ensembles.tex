...
\begin{scope}[on background layer]
    ...
    \aggregation{OneSphereMove}{spheres}{2}{AbstractDipolarSpheres}
    \aggregation{OneSphereMove}{boxed}{2}{AbstractBoxedSpheres}
    \aggregation{OneSphereMove}{random}{2}{AbstractRandomCoordinates}
    ...
    \aggregation{OneSphereRotation}{spheres}{2}{AbstractDipolarSpheres}
    \aggregation{OneSphereRotation}{random}{2}{AbstractRandomCoordinates}
    ...
    \aggregation{TwoSpheresSwitch}{spheres}{2}{AbstractDipolarSpheres}
    \aggregation{TwoSpheresSwitch}{boxed}{2}{AbstractBoxedSpheres}
    ...
    \aggregation{OneSphereExchange}{spheres}{2}{AbstractDipolarSpheres}
    \aggregation{OneSphereExchange}{boxed}{2}{AbstractBoxedSpheres}
