...
\begin{scope}[on background layer]
    \aggregation{AbstractPairInteraction}{boxGeometry}{1}{AbstractBoxGeometry}
    ...
    \aggregation{AbstractNeighbourCells}{boxGeometry}{1}{AbstractBoxGeometry}
    ...
    \aggregation{WallsInteraction}{boxGeometry}{1}{AbstractBoxGeometry}
