...
private
    ...
    contains
        ...
        procedure :: ePot => particle_ePot
        procedure :: ePotNeigh => particle_ePotNeigh
        procedure :: mcMove => particle_mcMove
...
contains
    ...
    function particle_ePot(this, r) result(ePot)
    ...
    end function particle_ePot
    
    ! -----------------------
    
    subroutine particle_ePotNeigh(this, iCol, xCol, iCell, overlap, energ)
    ...
    end subroutine particle_ePotNeigh
    
    ! Déplacement d'une particule ---------------------------------------------
    
    subroutine particle_mcMove(this, enTot, Nrejects)
    ...
    end subroutine particle_mcMove
    
    ! Méthode de Widom --------------------------------------------------------

    subroutine particle_widom(this, nWidom, activExInv)
