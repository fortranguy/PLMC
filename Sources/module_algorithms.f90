...
contains
    ...
    subroutine before_switch_energy(this, this_iCol, other, other_iCol, mix, indicesOld, EpotsOld)
        ...
        write(*, *) "-s-", this%mixCells%index_from_position(xOld), other%mixCells%index_from_position(xOld)
