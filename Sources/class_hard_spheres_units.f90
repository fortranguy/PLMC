...
contains
    ...
    subroutine Hard_Spheres_Units_open(this, name)
        ...
        open(newunit=this%potential_energy, recl=4096, file=name//"_potential_energy.tmp", status='new', action='write')
        ...
        select type (this)
            ...
            type is (Dipolar_Hard_Spheres_Units)
                ...
                open(newunit=this%potential_energy_real, recl=4096, file=name//"_potential_energy_real.tmp", status='new', &
                     action='write')
