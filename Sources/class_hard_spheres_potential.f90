...
contains
    ...
    subroutine Hard_Spheres_Potential_Energy_construct(this, min_distance_factor, diameter)    
    ...
    subroutine Hard_Spheres_Potential_Energy_neighCells(this, Box_size, this_spheres, this_cells, particle, &
                                                 overlap, energ)
