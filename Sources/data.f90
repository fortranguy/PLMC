...
!***********************************************************************
    ...
    use data_constants
    use data_particles
    integer, parameter :: Nstep = 1 ! 10**3
    integer, parameter :: Ntherm = 1 ! 4
    integer, parameter :: Nmove = 1 ! 40*Ncol1 ! new
...
!***********************************************************************
    ...
    real(DP), parameter :: pas11 = 5.E-1_DP ! new
    ...
    real(DP), dimension(iMin:Ntab11) :: rTab11, Vtab11 ! attention : modifiable
