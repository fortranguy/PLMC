...
!***********************************************************************
    ...
    use data_constants
    use data_particles
    integer, parameter :: Nstep = 10**2
    integer, parameter :: Ntherm = 10**2 ! 4
    integer, parameter :: Nmove = 10**2 ! 40*Ncol1 ! new
...
!***********************************************************************
    ...
    real(DP), dimension(Ntab11+1) :: rTab11, Vtab11 ! attention : modifiable
