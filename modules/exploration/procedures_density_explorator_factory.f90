module procedures_density_explorator_factory
...
use classes_density_explorator, only: Abstract_Density_Explorator, Plain_Density_Explorator
...
contains
    ...
    subroutine create(density_explorer, periodic_box, visitable_walls, num_snaps, exploring_data, &
        prefix)
        class(Abstract_Density_Explorator), allocatable, intent(out) :: density_explorer
        ...
        call construct(density_explorer, periodic_box, visitable_walls, num_snaps, exploring_data, &
            prefix)
    ...
    subroutine allocate(density_explorer, density_type)
        ...
        select case(density_type)
            case ("plain")
                allocate(Plain_Density_Explorator :: density_explorer)
            case ("z")
            case ("xz")
            case default
                call error_exit("procedures_density_explorator_factory: allocate: "//&
                    "density_type unknown. Please choose between 'plain', 'z' or 'xz'.")
        end select
    end subroutine allocate

    subroutine construct(density_explorer, periodic_box, visitable_walls, num_snaps, &
        exploring_data, prefix)
        class(Abstract_Density_Explorator), intent(inout) :: density_explorer
        class(Abstract_Periodic_Box), intent(in) :: periodic_box
        class(Abstract_Visitable_Walls), intent(in) :: visitable_walls
        integer, intent(in) :: num_snaps
        type(json_file) :: exploring_data
...
end module procedures_density_explorator_factory
