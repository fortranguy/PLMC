...
contains
    ...
    subroutine metropolis_algorithms_set(metropolis_algorithms, components, change_components)
        type(Metropolis_Algorithms_Wrapper), intent(inout) :: metropolis_algorithms
        type(Component_Wrapper), intent(in) :: components(:)
        type(Changes_Component_Wrapper), intent(in) :: change_components(:)

        call one_particle_move_set(metropolis_algorithms%one_particle_move, components, &
            change_components)
        call one_particle_rotation_set(metropolis_algorithms%one_particle_rotation, &
