...
contains
    ...
    subroutine create(structure, environment, box_volume_memento, components, are_dipolar)
        ...
        call structure%construct(environment%periodic_box, box_volume_memento, environment%&
