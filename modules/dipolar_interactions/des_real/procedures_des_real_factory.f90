...
use procedures_des_real_pair_factory, only: des_real_pair_create, des_real_pair_destroy
use procedures_des_real_component_factory, only: des_real_component_create, &
    des_real_component_destroy
use procedures_des_real_visitor_factory, only: des_real_visitor_create, des_real_visitor_destroy
        ...
        do j_component = 1, size(components, 2)
            do i_component = 1, size(components, 1)
                ...
                associate (potential_ij => real_pairs(j_pair)%line(i_pair)%potential)
                    call des_real_create(components(i_component, j_component)%component, &
