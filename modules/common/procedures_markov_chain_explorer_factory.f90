...
contains
    ...
    subroutine create(markov_chain_explorer, physical_model, exploring_data)
        ...
        call random_coordinates_create(markov_chain_explorer%random_position, physical_model%&
            environment%periodic_box, can_exchange, have_positions, exploring_data, widom_prefix)
