...
use procedures_average_nums_particles_factory, only: average_nums_particles_create => create, &
    average_nums_particles_destroy => destroy
...
interface create
    ...
    module procedure :: average_nums_particles_create
end interface create

interface destroy
    module procedure :: average_nums_particles_destroy
