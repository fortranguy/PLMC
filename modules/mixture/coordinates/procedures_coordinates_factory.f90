...
use procedures_component_dipolar_moments_factory, only: component_dipolar_moments_create => create,&
    component_dipolar_moments_destroy => destroy
...
interface create
    ...
    module procedure :: component_dipolar_moments_create
end interface create

interface destroy
    module procedure :: component_dipolar_moments_destroy
