...
contains
    ...
    subroutine visit_cells_energies(overlap, energies, components, short_interactions)
        logical, intent(out) :: overlap
        type(Reals_Line), intent(inout) :: energies(:)
        type(Component_Wrapper), intent(in) :: components(:)
        type(Short_Interactions_Wrapper), intent(in) :: short_interactions
    ...
    subroutine visit_cells_contacts(overlap, contacts, components, short_interactions)
        logical, intent(out) :: overlap
