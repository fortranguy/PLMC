...
contains
    ...
    subroutine create_move(move_tuner, moved_positions, tuner_parameters, num_tuning_steps)
        ...
        call move_tuner%construct(moved_positions, tuner_parameters, num_tuning_steps)
