...
private
    ...
    end type Abstract_Widom_Method

    type, extends(Abstract_Widom_Method), public :: Concrete_Widom_Method

    end type Concrete_Widom_Method

    type, extends(Abstract_Widom_Method), public :: Null_Widom_Method
    contains
        procedure :: construct => Null_construct
        procedure :: destroy => Null_destroy
        procedure :: try => Null_try
    end type Null_Widom_Method
...
!implementation Abstract_Widom_Method
    ...
    subroutine Abstract_destroy(this)
        class(Abstract_Widom_Method), intent(inout) :: this
    ...
    subroutine Abstract_try(this, observables)
        ...
        do i_component = 1, size(this%numbers)
            ...
            do i_particle = 1, this%numbers(i_component)%get()
                ...
                observables%widom_counters(i_component)%num_hits = observables%&
    ...
    subroutine Abstract_visit_short(this, overlap, deltas, i_component, test)
        ...
        do j_component = 1, size(this%short_interactions%visitable_cells, 1)
            ...
            call this%short_interactions%visitable_cells(j_component, i_component)%&
                visit(overlap, deltas(j_component), test, i_exclude)
                if (overlap) return
        end do
...
!end implementation Abstract_Widom_Method
...
!implementation Null_Widom_Method
    ...
    subroutine Null_destroy(this)
        class(Null_Widom_Method), intent(inout) :: this
    end subroutine Null_destroy

    subroutine Null_try(this, observables)
        class(Null_Widom_Method), intent(in) :: this
        type(Exploring_Observables_Wrapper), intent(inout) :: observables
    end subroutine Null_try

!end implementation Null_Widom_Method

end module classes_widom_method
