...
use procedures_box_volume_memento_factory, only: box_volume_memento_create => create, &
    box_volume_memento_destroy => destroy
...
interface create
    ...
    module procedure :: box_volume_memento_create
...
interface destroy
    ...
    module procedure :: box_volume_memento_destroy
