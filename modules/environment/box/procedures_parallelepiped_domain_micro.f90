...
implicit none
    ...
    abstract interface
        ...
        pure logical function is_inside_box(box_size, point_from_corner)
        import :: DP
...
private
public :: point_is_inside, is_inside_included, is_inside_excluded

contains

    pure logical function point_is_inside(box_origin, box_size, point, is_inside)
        real(DP), intent(in) :: box_origin(:), box_size(:), point(:)
        procedure(is_inside_box) :: is_inside
        ...
        point_is_inside = is_inside(box_size, point_from_corner)
