!Calculate the radial distribution function from snap shots of 2 component_1s
!> \[
...
implicit none
    ...
    do i_snap = 1, num_snaps
        ...
        call create_coordinates_from_file(component_1%positions, snap_filename)
        component_1%num_particles = size(component_1%positions, 2)
        call create_filename_from_argument(snap_filename, num_snaps + i_snap)
        call create_coordinates_from_file(component_2%positions, snap_filename)
