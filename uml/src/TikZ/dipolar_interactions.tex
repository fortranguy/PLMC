\begin{scope}[shift={($(Material.north) + (50 cm, 55cm)$)}]
    \begin{package}{Dipolar interactions}
        ...
        \begin{scope}[shift={($(DipolarInteractions.south) + (-19.5 cm, -5 cm)$)}]
        ...
        \begin{scope}[shift={($(DipolarInteractions.south) + (-6.5 cm, -5 cm)$)}]
        ...
        \begin{scope}[shift={($(DipolarInteractions.south) + (32.5 cm, -5 cm)$)},
        ...
        \begin{scope}[shift={($(DipolarInteractions.south) + (45.5 cm, -5 cm)$)},
