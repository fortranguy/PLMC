\begin{scope}[local bounding box=Material]
    \begin{package}{Material}
        ...
        \begin{scope}[local bounding box=Spheres]
            ...
            \begin{class}[text width=\mediumTextWidth]{ApolarSpheres}{0, -5.5}
                \inherit{AbstractDipolarSpheres}
                \operationsImplementation{}
            \end{class}
            
            \begin{class}[text width=\mediumTextWidth]{DipolarSpheres}{0, -8.5}
                \inherit{AbstractDipolarSpheres}
                \operationsImplementation{}
            \end{class}
        \end{scope}
        
        \begin{scope}[shift={($(Spheres.north) - (21 cm, 0)$)}]
        ...
        \begin{scope}[shift={($(Spheres.north)!0.5!(BoxGeometry.north) + (-9 cm, 16 cm)$)}]
            \begin{abstractclass}[text width=\mediumTextWidth]{AbstractSmallChange}{0, 0}
                \operation[0]{randomMove(iSphere : int) : double[3]}
            ...
            \begin{class}[text width=\mediumTextWidth]{SmallChange}{0, -5.5}
                \inherit{AbstractSmallChange}
                \operationsImplementation{}
            \end{class}
        \end{scope}
...
\begin{scope}[on background layer]
    ...
    \composition{AbstractSmallChange}{spheres}{1}{AbstractDipolarSpheres}
\end{scope}
