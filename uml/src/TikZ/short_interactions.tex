\begin{scope}[shift={($(Material.north) + (-20 cm, 55 cm)$)}]
    \begin{package}{Short range interactions}
        ...
        \begin{scope}[local bounding box=PairInteractions,
            shift={($(ShortInteraction.south) + (-8 cm, -2 cm)$)}]
            \begin{abstractclass}[text width=\extraLargeTextWidth]{AbstractPairInteractions}{0, 0}
            ...
            \begin{class}[text width=\extraLargeTextWidth]{IntraShortInteration}{0, -3}
                \inherit{AbstractPairInteractions}
                \operationsImplementation{}
            \end{class}            
            
            \begin{class}[text width=\extraLargeTextWidth]{InterShortInteration}{0, -6.5}
                \inherit{AbstractPairInteractions}
                \operationsImplementation{}
            \end{class}
        \end{scope}
        
        \begin{scope}[shift={($(PairInteractions.south) + (-8 cm, -3.5 cm)$)}]
        ...
        \begin{scope}[local bounding box=WallInteraction, 
            ...
            \begin{class}[text width=\extraLargeTextWidth]{NullWallInteraction}{0, -3}
...
\begin{scope}[on background layer]
    \composition{AbstractPairInteractions}{box}{1}{AbstractBoxGeometry}
    \composition{AbstractPairInteractions}{neighbourCells}{1}{AbstractNeighbourCells}
    \composition{AbstractPairInteractions}{pairPotential}{1}{AbstractPairPotential}
