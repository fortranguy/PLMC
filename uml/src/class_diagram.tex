\begin{tikzpicture}
    ...
    \begin{scope}[shift={($(Material.north) + (-15 cm, 15cm)$)}]
        
        \begin{scope}[local bounding box=ShortPotential]
            \begin{abstractclass}[text width=\mediumTextWidth]{AbstractShortInteraction}{0, 0}
            ...
            \begin{class}[text width=\mediumTextWidth]{IntraShortInteration}{0, -4}
                \inherit{AbstractShortInteraction}
                \operation{totalEnergy() : double}
            \end{class}            
            \composition{IntraShortInteration}{spheres}{1}{AbstractSpheres}
            
            \begin{class}[text width=\mediumTextWidth]{InterShortInteration}{0, -6}
                \inherit{AbstractShortInteraction}
                \operation{totalEnergy() : double}
            \end{class}
