\begin{tikzpicture}
    ...
    \begin{scope}[shift={($(Material.north) + (-20 cm, 30cm)$)}]
        \begin{package}{Short range interaction}
            ...
            \begin{scope}[shift={($(ShortInteraction.south) + (-5 cm, -2 cm)$)}]
    ...
    \begin{scope}[shift={($(Material.north) + (30 cm, 40cm)$)}]
        \begin{package}{Dipolar interaction}
            ...
            \begin{scope}[shift={($(DipolarInteraction.south) + (-19.5 cm, -2 cm)$)}]
                ...
                \begin{class}[text width=\largeTextWidth]{EwaldReal}{0, -9}
                    \inherit{AbstractEwaldReal}
                    \operation{totalEnergy() : double}
                    \operation{totalEnergyUsingField() : double}
                    \operation{moveEnergy(old : Particle, new : Particle) : double}
                ...
                \begin{class}[text width=\largeTextWidth]{InterEwaldReal}{0, -16}
                    \inherit{AbstractEwaldReal}
                    \operation{totalEnergy() : double}
                    \operation{totalEnergyUsingField() : double}
                    \operation{moveEnergy(old : Particle, new : Particle) : double}
            ...
            \begin{scope}[shift={($(DipolarInteraction.south) + (19.5 cm, -2 cm)$)}]
                ...
                \begin{class}[text width=\largeTextWidth]{EwaldSelf}{0, -9}
                    \inherit{AbstractEwaldSelf}
                    \operation{totalEnergy() : double}
                    \operation{totalEnergyUsingField() : double}
                    \operation{moveEnergy(old : Particle, new : Particle) : double}
            ...
            \begin{scope}[shift={($(DipolarInteraction.south) + (32.5 cm, -2 cm)$)},
                ...
                \begin{class}[text width=\largeTextWidth]{EwaldBound}{0, -9}
                    \inherit{AbstractEwaldBound}
                    \operation{totalEnergy() : double}
                    \operation{totalEnergyUsingField() : double}
                    \operation{moveEnergy(old : Particle, new : Particle) : double}
                ...
                \begin{class}[text width=\largeTextWidth]{InterEwaldBound}{0, -16}
                    \inherit{AbstractEwaldBound}
                    \operation{totalEnergy() : double}
                    \operation{totalEnergyUsingField() : double}
                    \operation{moveEnergy(old : Particle, new : Particle) : double}
            ...
            \begin{scope}[shift={($(DipolarInteraction.south) + (45.5 cm, -2 cm)$)},
                ...
                \begin{class}[text width=\largeTextWidth]{FieldInteraction}{0, -9}
                    \inherit{AbstractFieldInteraction}
                    \operation{totalEnergy() : double}
                    \operation{totalEnergyUsingField() : double}
                    \operation{moveEnergy(old : Particle, new : Particle) : double}
            ...
            \begin{scope}[shift={($(EwaldBound.south)!0.5!(FieldInteraction.south) + (0 cm, -4 cm)$)}]
            ...
            \begin{scope}[shift={($(EwaldBound.south)!0.5!(FieldInteraction.south) + (13 cm, -2 cm)$)}]
                \begin{abstractclass}[text width=\smallTextWidth]{AbstractExternalField}{0, 0}
                    \operation[0]{getTotalMoment() : double[3]}
                \end{abstractclass}

                \begin{class}[text width=\smallTextWidth]{ConstantExternalField}{0, -2.5}
                    \inherit{AbstractExternalField}
                    \operation{getTotalMoment() : double[3]}
                \end{class}

                \begin{class}[text width=\smallTextWidth]{NonUniformExternalField}{0, -4.5}
                    \inherit{AbstractExternalField}
                    \operation{getTotalMoment() : double[3]}
                \end{class}
            \end{scope}
    ...
    \composition{AbstractEwaldBound}{totalMoment}{1}{AbstractTotalMoment}
    \composition{AbstractFieldInteraction}{totalMoment}{1}{AbstractTotalMoment}
    \composition{AbstractFieldInteraction}{extField}{1}{AbstractExternalField}
