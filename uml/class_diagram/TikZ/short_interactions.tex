...
\begin{scope}[on background layer]
    \aggregation{ShortInteractionFacade}{pairInteraction}{2}{AbstractPairInteraction}
    \aggregation{ShortInteractionFacade}{wallsInteraction}{1}{AbstractWallsInteraction}
    ...
    \aggregation{IntraPairInteration}{spheres}{1}{AbstractDipolarSpheres}
    \aggregation{InterPairInteration}{spheres}{2}{AbstractDipolarSpheres}
    ...
    \aggregation{AbstractNeighbourCells}{spheres}{1}{AbstractDipolarSpheres}
    ...
    \aggregation{WallsInteraction}{spheres}{1}{AbstractDipolarSpheres}
\end{scope}
