\begin{scope}[shift={($(Material.north) + (50 cm, 55 cm)$)}]
    \begin{package}{Dipolar interactions}
        ...
        \begin{scope}[shift={($(InterEwaldReci.south)!0.5!(InterDipolarLayerCorrection.south) +
            (0 cm, -4 cm)$)}]
            \begin{abstractclass}[text width=\largeTextWidth]{AbstractStructureFactor}{0, 0}
                \operation[0]{getStructureFactor()}
                \operation[0]{moveEnergy(old : Particle, new : Particle) : double}
                \operation[0]{moveUpdate(old : Particle, new : Particle)}
                \operation[0]{rotationEnergy(old : Particle, new : Particle) : double}
                \operation[0]{rotationUpdate(old : Particle, new : Particle)}
            ...
            \begin{class}[text width=\largeTextWidth]{EwaldReciStructureFactor}{0, -5.5 cm}
                \operationsImplementation{}
            \end{class}
        \end{scope}
        ...
        \begin{scope}[shift={($(InterEwaldBound.south)!0.5!(FieldInteraction.south) +
            (0 cm, -6 cm)$)}]
        ...
        \begin{scope}[shift={($(FieldInteraction.south) + (4 cm, -4 cm)$)}]
