...
public :: Concrete_Particle_Energy_sum, operator(+), operator(-)
    ...
    interface operator(+)
        module procedure :: Concrete_Particle_Energy_addition
    end interface
...
contains
    ...
    pure function Concrete_Particle_Energy_sum(particle_energy) result(particle_energy_sum)
        ...
        particle_energy_sum = particle_energy%intra + particle_energy%inter + particle_energy%walls
    ...
    function Concrete_Particle_Energy_addition(particle_energy_1, particle_energy_2) &
        result(particle_energy_addition)
        type(Concrete_Particle_Energy) :: particle_energy_addition
        ...
        particle_energy_addition%inter = particle_energy_1%inter + particle_energy_2%inter
        particle_energy_addition%walls = particle_energy_1%walls + particle_energy_2%walls
    end function Concrete_Particle_Energy_addition
