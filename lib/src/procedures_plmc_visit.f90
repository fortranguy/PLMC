...
contains
    ...
    subroutine visit_mixture(observables, walls_potential, short_potentials, mixture)
    ...
    pure subroutine visit_particles(overlap, energy, potential, positions, pair, same_type)
        logical, intent(out) :: overlap
        real(DP), intent(out) :: energy
