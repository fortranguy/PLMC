...
contains
    ...
    subroutine Concrete_Changes_Counter_reset(changes_counter)
    ...
    subroutine reset(changes_counter)
    ...
    subroutine Concrete_Changes_Counter_set(changes_success, changes_counter)
    ...
    real(DP) function get_ratio(change_counter)
