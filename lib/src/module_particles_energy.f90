module module_component_energy
...
private
public :: Concrete_Component_Energy_sum, Concrete_Inter_Energy_sum, &
    operator(+), operator(-)
    ...
    type, public :: Concrete_Component_Energy
        real(DP) :: short = 0._DP
        real(DP) :: walls = 0._DP
        real(DP) :: long = 0._DP
        !real(DP) :: field = 0._DP
    end type Concrete_Component_Energy
    ...
    type, public :: Concrete_Mixture_Energy
        type(Concrete_Component_Energy) :: intras(2)
        type(Concrete_Inter_Energy) :: inter
    end type Concrete_Mixture_Energy

    interface assignment(=)
        module procedure :: Concrete_Component_Energy_assignment
        module procedure :: Concrete_Inter_Energy_assignment
    end interface

    interface operator(+)
        module procedure :: Concrete_Component_Energy_addition
        module procedure :: Concrete_Inter_Energy_addition
    end interface

    interface operator(-)
        module procedure :: Concrete_Component_Energy_difference
        module procedure :: Concrete_Inter_Energy_difference
    end interface

contains

!implementation Concrete_Component_Energy

    pure function Concrete_Component_Energy_sum(particle_energy) result(particle_energy_sum)
        type(Concrete_Component_Energy), intent(in) :: particle_energy
        real(DP) :: particle_energy_sum

        particle_energy_sum = particle_energy%short + particle_energy%walls + particle_energy%long
    end function Concrete_Component_Energy_sum

    pure subroutine Concrete_Component_Energy_assignment(particle_energy_target, &
        particle_energy_value)
        type(Concrete_Component_Energy), intent(out) :: particle_energy_target
        type(Concrete_Component_Energy), intent(in) :: particle_energy_value
    ...
    end subroutine Concrete_Component_Energy_assignment

    function Concrete_Component_Energy_addition(particle_energy_1, particle_energy_2) &
        result(particle_energy_addition)
        type(Concrete_Component_Energy) :: particle_energy_addition
        type(Concrete_Component_Energy), intent(in) :: particle_energy_1, particle_energy_2
    ...
    end function Concrete_Component_Energy_addition

    function Concrete_Component_Energy_difference(particle_energy_1, particle_energy_2) &
        result(particle_energy_difference)
        type(Concrete_Component_Energy) :: particle_energy_difference
        type(Concrete_Component_Energy), intent(in) :: particle_energy_1, particle_energy_2
    ...
    end function Concrete_Component_Energy_difference

!end implementation Concrete_Component_Energy
...
end module module_component_energy
