...
contains
    ...
    subroutine create_all(short_potentials, periodic_box, mixture, input_data, prefix)
        ...
        call short_potentials_create(short_potentials%inter_cells, interact, periodic_box, &
            mixture%components, short_potentials%inter_pairs, list)
        call deallocate_list(list)
        call short_potentials_create(short_potentials%visitor, interact, periodic_box)
    end subroutine create_all

    subroutine destroy_all(short_potentials)
        type(Short_Potentials_Wrapper), intent(inout) :: short_potentials

        call short_potentials_destroy(short_potentials%visitor)
    ...
    subroutine create_visitor(visitor, interact, periodic_box)
    ...
    subroutine create_pair(pair, interact, min_distance, expression, &
        input_data, prefix)
        ...
        call construct_pair(pair, interact, min_distance, expression, input_data, prefix)
    ...
    subroutine construct_pair(pair, interact, min_distance, expression, input_data, prefix)
