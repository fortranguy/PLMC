...
private
    ...
    contains
        ...
        procedure(Abstract_Diameters_get_num), deferred :: get_num
    ...
    abstract interface
        ...
        pure function Abstract_Diameters_get_num(this) result(num_diameters)
        import :: Abstract_Diameters
            class(Abstract_Diameters), intent(in) :: this
            integer :: num_diameters
        end function Abstract_Diameters_get_num
    ...
    contains
        ...
        procedure :: get_num => Uniform_Diameters_get_num
...
!implementation Uniform_Diameters
    ...
    subroutine Uniform_Diameters_set(this, i_particle, diameter)
        ...
        if (.not. this%is_set) then
            this%is_set = .true.
        else if (abs(diameter - this%diameter) > real_zero) then
            call warning_continue("Uniform_Diameters: setting diameter is different.")
        end if
        this%diameter = diameter
    end subroutine Uniform_Diameters_set

    pure function Uniform_Diameters_get_num(this) result(num_diameters)
